...
#include "cosAccelerationFvPatchVectorField.H"
...
Foam::cosAccelerationFvPatchVectorField::cosAccelerationFvPatchVectorField
(
    const fvPatch& p,
    ...
    minZ_(0.0)
{
    ...
    Info << "Executing cosAccelerationFvPatchVectorField(fvPatch, DimensionedField) " << endl;
}


Foam::cosAccelerationFvPatchVectorField::cosAccelerationFvPatchVectorField
(
    const cosAccelerationFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
    ...
    minZ_(ptf.minZ_)
{
    ...
    Info << "Executing cosAccelerationFvPatchVectorField(cosAcceleration, fvPatch, DimensionedField, fvPatchFieldMapper) " << endl;
}
    ...
    mixedFvPatchField<vector>(p, iF)
{
    ...
    Info << "Executing cosAccelerationFvPatchVectorField(fvPatch, DimensionedField, dictionary) " << endl;
}


Foam::cosAccelerationFvPatchVectorField::cosAccelerationFvPatchVectorField
(
    const cosAccelerationFvPatchVectorField& ptpsf
)
:
...
{
    this->setPatchVelocities(this->refValue());
    Info << "Executing cosAccelerationFvPatchVectorField(const cosAcceleration&) " << endl;
}
    ...
    minZ_(ptpsf.minZ_)
{
    ...
    Info << "Executing cosAccelerationFvPatchVectorField(const cosAcceleration, const DimensionedField) " << endl;
}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::cosAccelerationFvPatchVectorField::autoMap(const fvPatchFieldMapper& m)
{
...
void Foam::cosAccelerationFvPatchVectorField::rmap(const fvPatchVectorField& pf, const labelList& ll)
{
    mixedFvPatchField<vector>::rmap(pf, ll);
    Info << "Executing rmap " << endl;
}

void Foam::cosAccelerationFvPatchVectorField::setPatchVelocities (vectorField& pV)
{
	...
	pV[iFace] = 
	    A_ * cos(Foam::constant::mathematical::pi * z[iFace] / H_) * (-omega0_) * (omega0_) * cos(omega0_ * t + phi0_);
...
void Foam::cosAccelerationFvPatchVectorField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void Foam::cosAccelerationFvPatchVectorField::write(Ostream& os) const
{
